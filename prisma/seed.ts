...
async function up() {
    ...
    const pizza1 = await prisma.product.create({
        data: {
            ...
            imageUrl:
                '/assets/images/products/cheese_chicken_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [1, 2, 4, 14].includes(el.id)),
            },
        },
    });
    ...
    const pizza2 = await prisma.product.create({
        data: {
            name: 'Піца Шинка Сир',
            imageUrl:
                '/assets/images/products/cheese_ham_pizza.png',
            categoryId: 1,
            ingredients: {
    ...
    const pizza3 = await prisma.product.create({
        data: {
            name: 'Піца Сирна',
            imageUrl:
                '/assets/images/products/cheese_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [1, 2, 3, 16].includes(el.id)),
            },
        },
    });
    ...
    const pizza4 = await prisma.product.create({
        data: {
            ...
            imageUrl:
                '/assets/images/products/chorizo_fresh_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [4, 2, 3, 9, 14, 15].includes(el.id)),
            },
        },
    });
    ...
    const pizza5 = await prisma.product.create({
        data: {
            ...
            imageUrl:
                '/assets/images/products/double_chicken_pizza.png',
            categoryId: 1,
            ingredients: {
    ...
    const pizza6 = await prisma.product.create({
        data: {
            ...
            imageUrl:
                '/assets/images/products/double_pepperoni_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [2, 8, 11, 12, 14].includes(el.id)),
            },
        },
    });
    ...
    const pizza7 = await prisma.product.create({
        data: {
            name: 'Піца Гавайська',
            imageUrl:
                '/assets/images/products/hawaiian_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [2, 5, 10, 13, 15].includes(el.id)),
            },
        },
    });
    ...
    const pizza8 = await prisma.product.create({
        data: {
            name: 'Піца Жульєн',
            imageUrl:
                '/assets/images/products/julien_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [2, 5, 6, 7].includes(el.id)),
            },
        },
    });
    ...
    const pizza9 = await prisma.product.create({
        data: {
            name: 'Піца Маргаріта',
            imageUrl:
                '/assets/images/products/margherita_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [2, 11, 14].includes(el.id)),
            },
        },
    });
    ...
    const pizza10 = await prisma.product.create({
        data: {
            name: 'Піца М\'ясна',
            imageUrl:
                '/assets/images/products/meat_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [2, 5, 7, 14, 17].includes(el.id)),
            },
        },
    });
    ...
    const pizza11 = await prisma.product.create({
        data: {
            ...
            imageUrl:
                '/assets/images/products/pepperoni_fresh_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [2, 8, 11, 14].includes(el.id)),
            },
        },
    });
    ...
    const pizza12 = await prisma.product.create({
        data: {
            name: 'Піца Пепероні',
            imageUrl:
                '/assets/images/products/pepperoni_pizza.png',
            categoryId: 1,
            ingredients: {
    ...
    const pizza13 = await prisma.product.create({
        data: {
            name: 'Піца Веганська',
            imageUrl:
                '/assets/images/products/vegan_pizza.png',
            categoryId: 1,
            ingredients: {
                connect: ingredients.filter(el => [4, 6, 11, 12, 14, 15].includes(el.id)),
            },
        },
    });
    ...
    await prisma.productItem.createMany({
        data: [
            ...new Array(products.length).fill(0).map((_, idx) => generateProductItem({ productId: idx + 1 })),
